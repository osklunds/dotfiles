...
- Skip separate colors and keybindings files
...
- When doing find-file, don't create file if no selection
...
- projectile project switch, if universal-arg, open dired instead
