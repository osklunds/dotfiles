...
#+begin_src emacs-lisp
  ...
  (defun msk-merge-survival-knife-start ()
    ...
    (let* ((file (magit-current-file))
      ...
      ;; (message "EDIFF %s" buffer-base-local)

      (msk--put-buffer 'base buffer-base)
      (msk--put-buffer 'local buffer-local)
      (msk--put-buffer 'remote buffer-remote)
      
      (msk--put-buffer 'base-local buffer-base-local)
      (msk--put-buffer 'base-remote buffer-base-remote)
      (msk--put-buffer 'local-remote buffer-local-remote)
      (msk--put-buffer 'local-merged buffer-local-merged)
      (msk--put-buffer 'remote-merged buffer-remote-merged)
      ))
  ...
  (defun msk-merge-survival-knife-stop ()
    ...
    (kill-buffer (msk--get-buffer 'base-local))
    (kill-buffer (msk--get-buffer 'base-remote))
    (kill-buffer (msk--get-buffer 'local-remote))
    (kill-buffer (msk--get-buffer 'local-merged))
    (kill-buffer (msk--get-buffer 'remote-merged))
  ...
  (defun msk--compare-buffer-pair (ediff-control-buffer)
    (switch-to-buffer (msk--get-buffer ediff-control-buffer))
