...
(ol-set-face-attribute 'smerge-base :background "#ffd787")
(ol-set-face-attribute 'smerge-lower :background "#E45649")
(ol-set-face-attribute 'smerge-upper :background "#9FEC9D")
